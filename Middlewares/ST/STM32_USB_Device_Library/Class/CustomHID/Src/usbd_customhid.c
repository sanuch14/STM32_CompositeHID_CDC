...
uint8_t  *USBD_CUSTOM_HID_GetCfgDesc (uint16_t *length);
                               ...
                               uint8_t cfgidx)
{
  ...
  else
  {
    ...
    hhid->state = CUSTOM_HID_IDLE;
		 ((USBD_CUSTOM_HID_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->HID)->Init();
                                 ...
                                 uint8_t cfgidx)
{
  ...
  if(pdev->pClassData != NULL)
  {
		((USBD_CUSTOM_HID_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->HID)->DeInit();
    ...
    case USB_REQ_GET_DESCRIPTOR: 
      if( req->wValue >> 8 == CUSTOM_HID_REPORT_DESC)
      {
        len = MIN(USBD_CUSTOM_HID_REPORT_DESC_SIZE , req->wLength);
				pbuf= ((USBD_CUSTOM_HID_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->HID)->pReport;
                              ...
                              uint8_t epnum)
{
  ...
  USBD_CUSTOM_HID_HandleTypeDef     *hhid = (USBD_CUSTOM_HID_HandleTypeDef*)pdev->pClassData;  
  ((USBD_CUSTOM_HID_ItfTypeDef *)((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->HID)->OutEvent(hhid->Report_buf[0], 
																																															hhid->Report_buf[1]);
                                             ...
                                             USBD_CUSTOM_HID_ItfTypeDef *fops)
{
  ...
  if(fops != NULL)
  {
    ((USBD_CDC_HID_ItfTypeDef *)pdev->pUserData)->HID = fops;
    ret = USBD_OK;    
  }
